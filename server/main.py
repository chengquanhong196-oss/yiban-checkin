...
.status{font-size:48px;margin-bottom:8px}.stats{background:#fff;border-radius:12px;padding:16px 24px;display:inline-block;margin:16px}
</style></head>
<body>
<h1>&#x2601;&#xFE0F; 易班云签到</h1>
...
<div class="card" style="border:2px solid #007aff"><h3>月付</h3><div class="price">¥6.9<span>/月</span></div><ul><li>每日自动签到</li><li>Mac 关机也能签</li><li>微信通知</li></ul><a href="https://afdian.com/a/yiban-checkin" class="btn btn-p">升级会员</a></div>
